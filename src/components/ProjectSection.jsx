...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-gray-200 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-00 transition sm:group-even:pl-8 group-hover:bg-purple-950 group-hover:text-white transition">
