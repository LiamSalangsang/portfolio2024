...
export default function Project({
  ...
  return (
    <motion.div
      ...
      className="group mb-3 sm:mb-8 last:mb-0 hover:text-white"
    >
      <section className="bg-gray-200  max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] sm:group-even:pl-8 group-hover:bg-purple-950 transition">
